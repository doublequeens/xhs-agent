...
_EXPORTS = {
    ...
    "content_atomizer_node": "src.nodes.node_p_content_atomizer",
    "visual_director_node": "src.nodes.node_p_visual_director",
    "page_designer_node": "src.nodes.node_p_page_designer",
    "design_plan_qa_node": "src.nodes.node_p_design_plan_qa",
    "design_reviser_node": "src.nodes.node_p_design_reviser",
    "generic_scene_renderer_node": "src.nodes.node_p_generic_scene_renderer",
    "visual_critic_node": "src.nodes.node_p_visual_critic",
