...
_POLICY_VALUES: dict[str, dict[str, float]] = {
    ...
    "image_annotation": {
        ...
        "orphan_line_max": 0.0,
        "orphan_heading_max": 0.0,
        "image_text_area_ratio_max": 3.5,
    },
    "summary_closing": {
        "whitespace_min": 0.22,
        "largest_text_block_max": 0.5,
        "regional_density_max": 0.85,
        "alignment_axis_deviation_max": 260.0,
        "paired_column_balance_max": 0.3,
        "spacing_consistency_max": 36.0,
...
_GRAMMAR_TASKS: dict[str, tuple[str, ...]] = {
    ...
    "diagnostic_matrix": ("diagnosis", "comparison"),
    "checklist": ("checklist", "step"),
    "evidence_card": ("diagnosis", "evidence"),
    "image_annotation": ("context", "diagnosis", "evidence"),
    "summary_closing": ("summary", "closing"),
}
