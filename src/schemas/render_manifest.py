...
class LegacyRenderModel(BaseModel):
    """Temporary import compatibility for the v2 renderer pending removal."""

    model_config = ConfigDict(extra="forbid")


class TextProbeResult(LegacyRenderModel):
...
class AssetProbeResult(LegacyRenderModel):
...
class PageProbeAttestation(LegacyRenderModel):
