...
_HUMAN_REVIEW_ASSET_CODES = ("HUMAN_REVIEW_ASSET_REJECTED",)
REVISION_FAILURE_CODES_V4 = tuple(
    sorted(set(SEMANTIC_ISSUE_CODES_V4 + get_args(AuthoringIssueCodeV4) + QUALITY_ISSUE_CODES_V4 + RENDER_ISSUE_CODES_V4 + _AESTHETIC_CODES + _HUMAN_REVIEW_ASSET_CODES))
)
...
_NODE_FAILURE_CODES_V4 = {
    ...
    "V4_HUMAN_REVIEW": frozenset(_HUMAN_REVIEW_ASSET_CODES),
}
